            ...
            public void invoke(long window, int key, int scancode, int action, int mods) {
                ...
                switch (key) {
                    case GLFW_KEY_ESCAPE://exit
                        ...
                        break;
                    case GLFW_KEY_O://toggle oversampling
                        font = (font + 1) % 3 + (font / 3) * 3;
                        break;
                    case GLFW_KEY_S://toggle font size
                        font = (font + 3) % 6;
                        break;
                    case GLFW_KEY_T://toggle translation
                    ...
                    case GLFW_KEY_R://toggle rotation
                        ...
                        rotate_t = 0.0f;
                        break;
                    case GLFW_KEY_P://toggle pixel-snap (only non-oversampled)
                        integer_align = !integer_align;
                        break;
                    case GLFW_KEY_G://toggle srgb gamma-correction
                        if (!supportsSRGB)
                            break;
                        ...
                        break;
                    case GLFW_KEY_V://view font texture
                        show_tex = !show_tex;
                        break;
                    case GLFW_KEY_B://toggle to black-on-white
